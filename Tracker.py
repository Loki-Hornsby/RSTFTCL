...
def spam():
    ...
    apply_encryption_effect("  _______ _    _ ______   _______ _____            _____ _  ________ _____    ___   ___   ___   ___   ")
    apply_encryption_effect(" |__   __| |  | |  ____| |__   __|  __ \     /\   / ____| |/ /  ____|  __ \  |__ \ / _ \ / _ \ / _ \  ")
    apply_encryption_effect("   | |   | |__| | |__       | |  | |__) |   /  \ | |    | ' /| |__  | |__) |    ) | | | | | | | | | | ")
    apply_encryption_effect("   | |   |  __  |  __|      | |  |  _  /   / /\ \| |    |  < |  __| |  _  /    / /| | | | | | | | | | ")
    apply_encryption_effect("   | |   | |  | | |____     | |  | | \ \  / ____ \ |____| . \| |____| | \ \   / /_| |_| | |_| | |_| | ")
    apply_encryption_effect("   |_|   |_|  |_|______|    |_|  |_|  \_\/_/    \_\_____|_|\_\______|_|  \_\ |____|\___/ \___/ \___/  ")
    apply_encryption_effect("                                                                                                      ")
